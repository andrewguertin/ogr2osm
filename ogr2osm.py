...
""" ogr2osm alpha
 ...
 This is in a alpha state, meaning "it works if you tweak it right".
 A gotcha is that there is no tag conversion, yet. The original attributes of the vector
 data will be used as tags.

 Another issue is that elevation in 2.5D features (that can be generated by reprojecting)
